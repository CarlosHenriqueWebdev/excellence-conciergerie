export default function AboutSkeleton() {
  return (
    <div className="pt-[100px] w-full px-[24px] lg:px-[80px] mx-auto max-w-[640px] md:max-w-full xl:max-w-[1280px] flex flex-col gap-[32px] md:grid md:grid-cols-[450fr_638fr] relative z-[10]">
