export default function HeroSkeleton() {
	return (
		<div className="select-none cursor-pointer relative flex justify-center items-center bg-placeholderBg w-full">
			<div className="relative z-[20] h-[100vh] flex justify-center items-center px-[24px] lg:px-[80px] w-full mx-auto max-w-[640px] md:max-w-full xl:max-w-[1280px] flex flex-col w-full">
