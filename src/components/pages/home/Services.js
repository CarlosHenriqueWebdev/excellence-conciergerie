...
export default function Services() {
  ...
  return (
    <div className="overflow-hidden">
      <div
        ref={introRef}
        className={`${isIntroInView ? "animated fadeInUp" : "opacity-0"} px-[24px] lg:px-[80px] mx-auto max-w-[640px] md:max-w-full xl:max-w-[1280px] flex flex-col gap-[16px] mb-[32px]`}
      >
        <div className="item">
      ...
      <div
        ref={sliderRef}
        className={`${isSliderInView ? "slide-right-animation" : "opacity-0"} item px-[24px] lg:px-[80px] mx-auto max-w-[640px] md:max-w-full xl:max-w-[1280px]`}
      >
        <Swiper
          autoplay={{
            delay: 6500,
