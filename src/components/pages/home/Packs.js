...
export default function Packs() {
  ...
  return (
    <div className="px-[24px] lg:px-[80px] mx-auto max-w-[640px] md:max-w-full xl:max-w-[1280px] flex flex-col gap-[32px] w-full">
      <div
        ref={introRef}
        className={`${isIntroInView ? "animated fadeInUp" : "opacity-0"} flex flex-col gap-[16px] md:text-center md:justify-center md:items-center`}
      >
        <div className="item">
      ...
      <ul
        ref={packsRef}
        className={`${isPacksInView ? "animated fadeInUp" : "opacity-0"} flex flex-col gap-[24px] md:grid md:grid-cols-[1fr_1fr] lg:grid-cols-[1fr_1fr_1fr] w-full`}
      >
